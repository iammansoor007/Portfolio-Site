  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "reveal-text": "reveal-text 1s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "cursor-pulse": "cursor-pulse 2s ease-in-out infinite",
      },
      backgroundImage: {
        "gradient-radial": "radial-gradient(var(--tw-gradient-stops))",
        "gradient-conic": "conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))",
        "hero-gradient": "linear-gradient(135deg, hsl(var(--primary) / 0.1), transparent 50%, hsl(var(--accent) / 0.1))",
